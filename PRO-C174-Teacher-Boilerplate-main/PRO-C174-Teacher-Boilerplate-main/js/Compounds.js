AFRAME.registerComponent("atoms", {
  ...
  getElementColors: function(){
    return fetch("js/elementColors.json").then(res=>res.json()).then(data=>data)
  },
  createAtoms: async function(element){
    ...
    nucleus.setAttribute("geometry",{primitive:"sphere",radius:nucleusRadius})
    ...
    for(var num=1;num<=numberOfElectrons;num++){
        ...
        orbit.setAttribute("geometry",{primitive:"torus",radius:0.28,arc:360,radiusTubular:0.001})
